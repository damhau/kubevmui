    ...
    <>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 24 }}>
            ...
            {form.disks.map((disk, i) => (
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
                  <span style={{ fontSize: 13, fontWeight: 600, color: theme.text.primary }}>Disk {i + 1}</span>
                  <button
        ...
        {step === 4 && (
          <div>
            {form.nics.map((nic, i) => (
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
                  <span style={{ fontSize: 13, fontWeight: 600, color: theme.text.primary }}>NIC {i + 1}</span>
                  <button
                    onClick={() => removeNIC(i)}
                    style={{
                      background: 'transparent',
        ...
        {step === 6 && (
          ...
          >
            <div style={{ fontSize: 14, fontWeight: 600, color: theme.text.heading, marginBottom: 16 }}>
            ...
            {[
              ...
              >
                <span style={{ minWidth: 120, color: theme.text.dim, fontWeight: 500, flexShrink: 0 }}>{label}</span>
